...
from src.dataset_scanner import DatasetScanner, DatasetProfile, DatasetStructure
...
class DatasetStatus:
    ...
    conversion_info: Optional[Dict] = None  # 转换相关信息
...
class AutoDatasetManager:
    ...
    def get_dataset_info(self, dataset_name: str) -> Optional[DatasetStatus]:
        """获取指定数据集的详细信息"""
